        ...
        <main class="flex-1 overflow-y-auto p-6 bg-gray-100">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
                ...
                <div class="order-1 md:order-none">
                    <h1 class="text-xl sm:text-2xl font-bold text-gray-800">Room Utilization Analytics</h1>
                ...
                <div class="divide-y divide-gray-200">
                    ...
                    <c:if test="${not empty cancellations}">
                        <div class="px-6 py-3 bg-gray-50 text-right">
                            <a href="${pageContext.request.contextPath}/admin/cancellations" class="text-sm font-medium text-blue-600 hover:text-blue-800">
