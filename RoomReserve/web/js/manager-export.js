document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('form[action*="/manager/export"]').forEach(form => {
    ...
    async function refreshExportHistory() {
        try {
            const response = await fetch(`${contextPath}/manager/export/history?page=${currentPage}&limit=${recordsPerPage}`);
