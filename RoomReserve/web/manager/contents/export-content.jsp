        ...
        <main class="flex-1 overflow-y-auto p-6 bg-gray-100">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                ...
                <div class="bg-white shadow rounded-lg p-6">
                    ...
                    <form action="${pageContext.request.contextPath}/manager/export" method="post">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <c:forEach items="${exports}" var="export" begin="${start}" end="${end-1 < 0 ? 0 : end-1}">
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <a href="${pageContext.request.contextPath}/manager/export/download?path=${export.filePath}"
...
<script src="${pageContext.request.contextPath}/js/manager-export.js"></script>
